        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1" style="text-align:center;">Data Nilai</h4>
                ...
                <div class="card-body">
                    <div class="live-preview">
                        ...
                        <div class="col-xxl-3 col-md-6">
                                <div>
                                    <label for="labelInput" class="form-label">Nilai</label>
                                    <input type="password" class="form-control" id="nilai A - nilai a">
                                </div>
                            </div>
                ...
                <a type="button" class="btn btn-primary" href="{{ url("pendaftaran6") }}" style="position:absolute;left:85%">Lanjut</a>
