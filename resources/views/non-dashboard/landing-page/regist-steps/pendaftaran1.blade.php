          ...
          <div class="row justify-content-between gy-4 mt-4">
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1" style="text-align:center;">Ketentuan</h4>
                ...
                <a type="button" class="btn btn-primary" href="{{ url("pendaftaran2") }}" style="position:absolute;left:85%">Lanjut</a>
              </div>
            </div>
          </div>
        </div>
