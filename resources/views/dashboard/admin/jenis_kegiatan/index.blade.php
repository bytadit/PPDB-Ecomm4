    ...
    <div class="row">
        <div class="col">
            <div class="h-100">
                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted mb-0">Silakan mengatur referensi kegiatan berikut!</p>
                            </div>
                ...
                <!--end row-->
                {{--                Modals Area--}}
                @include('dashboard.admin.jenis_kegiatan.modals.create')
                {{-- @include('dashboard.admin.feature1.modals.report') --}}
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header text-center">
                                <h1 class="mb-0">Referensi Kegiatan Pendaftaran</h1>
                            </div>
                            <div class="card-body">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center fw-medium">
                                                    ...
                                                    <button class="btn btn-sm btn-soft-warning mx-1"
                                                            ...
                                                            data-bs-target="#editData{{$activity->id}}">
                                                        <i class="ri-pencil-line"></i> <span>@lang('Ubah')</span>
                                                    </button>
                                                    <button class="btn btn-sm btn-soft-danger ml-1"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#deleteData{{$activity->id}}">
                                                        <i class="ri-delete-bin-line"></i> <span>@lang('Hapus')</span>
                                                    </button>
                                                </div>
                                            </td>
                                        </tr>
                                        @include('dashboard.admin.jenis_kegiatan.modals.edit')
                                        @include('dashboard.admin.jenis_kegiatan.modals.delete')
                                        {{-- @include('dashboard.admin.jenis_kegiatan.modals.show') --}}
                                    @endforeach
                                    </tbody>
                                </table>
                            </div>
