<div id="deleteData{{$activity->id}}" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="modalDelete{{$activity->id}}" aria-hidden="true">
