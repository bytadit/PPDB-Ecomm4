<div id="deleteDataRapor{{$rapor->id}}" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="modalDeleteRapor{{$rapor->id}}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center p-5">
                <form method="post" enctype="multipart/form-data" action="{{route('rapor.destroy', ['rapor' => $rapor->id])}}">
                    @csrf
                    @method('delete')
